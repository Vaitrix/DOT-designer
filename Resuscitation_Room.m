function Resuscitation_Room(Q,B,X)
...
A = [2*Q*B,2*Q*B,0,2*Q*B,0,2*Q*B,2*Q*B];
writematrix(A,'modular-DOT-Table.xlsx', 'Sheet', 1, 'Range','E7:K7');
...
M = ['M' np];
BB = ['B' np];
writematrix(A,'modular-DOT-Table.xlsx', 'Sheet', 1, 'Range', R);
